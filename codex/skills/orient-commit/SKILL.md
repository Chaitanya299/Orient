...
decisions directory, say so and offer `orient-decide` before drafting the message. This
catches decisions the proactive offer missed. If the user declines, or the change isn't
structural, continue.
